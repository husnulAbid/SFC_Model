...
data_analysis_meat_consumption_page = Blueprint('data_analysis_meat_consumption_page', __name__, template_folder='templates')

# sample : {base_url}/analysis/meat_consumption_time?country=NZL&start=1991&end=1995
@data_analysis_meat_consumption_page.route('/analysis/meat_consumption_time', methods=['GET'])
...
@data_analysis_meat_consumption_page.route('/analysis/meat_consumption_time/countries', methods=['GET'])
...
@data_analysis_meat_consumption_page.route('/analysis/meat_consumption_time/start_and_end_year', methods=['GET'])
